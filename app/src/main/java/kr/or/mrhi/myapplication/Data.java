...
import kr.or.mrhi.myapplication.coins.*;
...
public class Data {
    ...
    public True get_true() {
        return _true;
    }

    public void set_true(True _true) {
        this._true = _true;
    }
