...
public interface CoinRetrofit {
    ...
    Call<CoinViewModel.FormerData> getCandlestickCoinData(@Path("order_currency") String order_currency, @Path("payment_currency") String payment_currency, @Path("chart_intervals") String chart_intervals);
