...
public class CoinMain extends AppCompatActivity implements View.OnClickListener{
    private TextView coinName,coinSymbol,currentCoinPrice, totalPrice, orderPossibleCoin;
    ...
    private Double totalPriceTemp = 0.00;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinSymbol = findViewById(R.id.coinName);
...
//        btnBuying.setOnClickListener(this);
        ...
        model.getTransactionCoinData(mainCoinName).observe(this, new Observer<List<String>>() {
            ...
            public void onChanged(List<String> stringList) {
                ...
                totalPrice.setText(String.format("%.2f",Double.parseDouble(stringList.get(position))*totalPriceTemp));
